...
::= (deftemplate \<deftemplate-name\> ;; TBD Here
...
\<pattern-CE\> ::= \<fact-pattern-CE\> \|

\<object-pattern-CE\>

\<fact-pattern-CE\> ::= \<ordered-pattern-CE\> \|

\<template-pattern-CE\>

\<assignable-CE\> ::= \<pattern-CE\> \|

\<explicit-CE\>

\<assigned-pattern-CE\> ::= \<single-field-variable\> \<- \<assignable-CE\>
