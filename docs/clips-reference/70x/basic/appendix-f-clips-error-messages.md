...
N is the number of nested instance‑set query functions.
  ...
  ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- --------------------------------------------------------
  ![](/Users/yrashk/Projects/inferaldata/inferal-workspace/repos/clipspyx/main/docs/clips-reference/70x/media/media/image9.emf){width="0.3888888888888889in" height="0.4722222222222222in"}   \<= 256 (the default upper limit)
