...
![](/Users/yrashk/Projects/inferaldata/inferal-workspace/repos/clipspyx/main/docs/clips-reference/70x/media/media/image22.png){width="4.66in" height="4.3in"}

### 6.3.2 Auto Demo

When launched, the Auto Demo window should appear (Forms version pictured):

![](/Users/yrashk/Projects/inferaldata/inferal-workspace/repos/clipspyx/main/docs/clips-reference/70x/media/media/image23.png){width="3.58in" height="2.21in"}

### 6.3.3 Animal Demo

When launched, the Animal Demo window should appear (WPF version pictured):

![](/Users/yrashk/Projects/inferaldata/inferal-workspace/repos/clipspyx/main/docs/clips-reference/70x/media/media/image24.png){width="3.58in" height="2.21in"}

### 6.3.4 Router Demo

When launched, the Router Demo window should appear (Forms version pictured):

![](/Users/yrashk/Projects/inferaldata/inferal-workspace/repos/clipspyx/main/docs/clips-reference/70x/media/media/image25.png){width="5.99in" height="3.05in"}
