...
• MacOS 13.2 with JDK 18.0.1.1 and Xcode 14.3

• Linux: Ubuntu 22.04 LTS with OpenJDK 11.0.17, Debian 11.3 with OpenJDK 11.0.18, Fedora 36 with OpenJDK 17.0.5, CentOS 9 with OpenJDK 11.0.17, and Mint 20.3 with OpenJDK 11.0.17.

## 7.1 CLIPSJNI Directory Structure

In order to use CLIPSJNI, you must obtain the source code by downloading either the *clips_jni_641.zip* or *clips_jni_641.tar.gz* file from the Files page on the CLIPS SourceForge web page (see appendix A for the SourceForge URL). When uncompressed the *CLIPSJNI* directory contains the following structure:
...
![](/Users/yrashk/Projects/inferaldata/inferal-workspace/repos/clipspyx/main/docs/clips-reference/70x/media/media/image26.png){width="3.2083333333333335in" height="2.85in"}
...
![](/Users/yrashk/Projects/inferaldata/inferal-workspace/repos/clipspyx/main/docs/clips-reference/70x/media/media/image27.png){width="5.291666666666667in" height="3.8916666666666666in"}
...
![](/Users/yrashk/Projects/inferaldata/inferal-workspace/repos/clipspyx/main/docs/clips-reference/70x/media/media/image28.png){width="3.925in" height="2.7083333333333335in"}
...
![](/Users/yrashk/Projects/inferaldata/inferal-workspace/repos/clipspyx/main/docs/clips-reference/70x/media/media/image29.png){width="3.175in" height="1.925in"}
...
![](/Users/yrashk/Projects/inferaldata/inferal-workspace/repos/clipspyx/main/docs/clips-reference/70x/media/media/image30.png){width="6.5in" height="4.813953412073491in"}
...
![](/Users/yrashk/Projects/inferaldata/inferal-workspace/repos/clipspyx/main/docs/clips-reference/70x/media/media/image31.png){width="3.716666666666667in" height="2.4833333333333334in"}
