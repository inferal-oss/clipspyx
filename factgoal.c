...
static void DetermineSlotFieldCounts(
  ...
  unsigned short *fieldCountArray)
  {
   ...
   /*==========================================*/
   /* Determine the field count for each slot. */
   /*==========================================*/
   
   for (i = 0; i < numberOfSlots; i++)
     {
      /*=======================================*/
      /* If the cardinalityArray for this slot */
      /* is true, then it's a multifield slot. */
      /*=======================================*/
      ...
      /*=====================================*/
      /* Otherwise, it's a single field slot */
      /* which has exactly one field.        */
      /*=====================================*/
         ...
         if (hack->pass && hack->p1rhs && hack->p2lhs)
           {
            ...
            if (hack->fromBeginning1)
              ...
              {
               theInfo->field = (fieldCountArray[hack->slot1] - 1) - hack->offset1;
      ...
      case FACT_JN_VAR3:
        {
         ...
         if (hack->fromBeginning)
           ...
           { theField = (fieldCountArray[theSlot] - 1) - hack->endOffset; }
      ...
      case FACT_PN_VAR3:
        {
         ...
         if (hack->fromBeginning)
           ...
           { sourceField = (fieldCountArray[sourceSlot] - 1) - hack->endOffset; }
